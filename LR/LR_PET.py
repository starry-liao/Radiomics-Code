...
# TODO: 请替换为您的CSV文件路径
train_df = pd.read_csv(r"REPLACE_WITH_YOUR_FILE.csv")   # 包含所有pet特征和标签
# TODO: 请替换为您的CSV文件路径
test_df = pd.read_csv(r"REPLACE_WITH_YOUR_FILE.csv")     
...
print(f"PET特征数：{len(existing_features)}")
...
param_grid = {
    ...
    'lr__solver': ['lbfgs'],# lbfgs支持L2正则化，适合小数据集
}
...
# print("\n最佳模型 Pipeline 已保存为 best_lr_pet_pipeline.pkl")
