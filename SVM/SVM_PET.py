...
# 确保特征在数据中存在
existing_features = [f for f in pet_features if f in train_df.columns]
missing = set(pet_features) - set(existing_features)
if missing:
...
# print("\n最佳模型 Pipeline 已保存为 best_svm_pet_pipeline.pkl")
